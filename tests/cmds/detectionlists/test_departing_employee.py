...
from code42cli.cmds.detectionlists.departing_employee import add_departing_employee
...
def test_add_departing_employee_when_given_cloud_aliases_adds_alias(sdk_with_user, profile):
    ...
    add_departing_employee(sdk_with_user, profile, "departing employee", cloud_aliases=[alias])
...
def test_add_departing_employee_adds(sdk_with_user, profile):
    add_departing_employee(sdk_with_user, profile, "departing employee")
    sdk_with_user.detectionlists.departing_employee.add.assert_called_once_with(TEST_ID)
...
def test_add_departing_employee_when_user_does_not_exist_print_error(
