...
from code42cli.subcommands.securitydata.subcommands.clear_checkpoint import clear_checkpoint


@pytest.fixture
def cursor_store(mocker):
    mock_init = mocker.patch(
        "code42cli.subcommands.securitydata.cursor_store.AEDCursorStore.__init__"
    )
