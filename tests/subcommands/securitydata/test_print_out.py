...
import code42cli.subcommands.securitydata.print_out as printer


@pytest.fixture
def logger_factory(mocker):
    return mocker.patch("code42cli.subcommands.securitydata.print_out.get_logger_for_stdout")


@pytest.fixture
def extractor(mocker):
    return mocker.patch("code42cli.subcommands.securitydata.print_out.extract")
