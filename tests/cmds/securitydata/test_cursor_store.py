...
from code42cli.cmds.search.cursor_store import BaseCursorStore, FileEventCursorStore
...
class TestFileEventCursorStore(object):
    ...
    def test_init_when_called_twice_with_different_profile_names_creates_two_rows(
        ...
        mock = mocker.patch(
            "{}.cmds.search.cursor_store.FileEventCursorStore._row_exists".format(PRODUCT_NAME)
        )
