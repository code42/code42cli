...
def test_bulk_add_roles_uses_expected_arguments(runner, mocker, cli_state_with_user):
    ...
    assert bulk_processor.call_args[0][1] == [
        {"username": "test0@example.com", "role_name": "Desktop User", "role added": "False"},
        {"username": "test1@example.com", "role_name": "Desktop User", "role added": "False"},
    ]
...
def test_bulk_remove_roles_uses_expected_arguments(runner, mocker, cli_state_with_user):
    ...
    assert bulk_processor.call_args[0][1] == [
        {"username": "test0@example.com", "role_name": "Desktop User", "role removed": "False"},
        {"username": "test1@example.com", "role_name": "Desktop User", "role removed": "False"},
    ]
