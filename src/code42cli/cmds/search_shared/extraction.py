...
def exit_if_advanced_query_used_with_other_search_args(args, white_list_args=None):
    args_dict_copy = args.__dict__.copy()
    white_list_args = white_list_args or []
    white_list_args.extend((u"advanced_query", u"format", u"sdk", u"profile"))
