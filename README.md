...
All errors are sent to an error log file named `c42seceventcli_errors.log` located in your python's site-packages.
To find the location of the log and look at the location:
