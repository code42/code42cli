...
_FORMAT_VALUE_ERROR_MESSAGE = "input must be a date in YYYY-MM-DD or YYYY-MM-DD HH:MM:SS format, or a short value in days, hours, or minutes (30d, 24h, 30m)"
...
def _get_dt_from_magic_time_pair(num, period):
    ...
    if period == "d":
        ...
        raise ValueError("Couldn't parse magic time string: {}{}".format(num, period))
    return dt
