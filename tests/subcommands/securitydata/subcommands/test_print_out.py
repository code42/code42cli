...
import code42cli.subcommands.securitydata.subcommands.print_out as printer
...
def extractor(mocker):
    return mocker.patch("code42cli.subcommands.securitydata.subcommands.print_out.extract")
