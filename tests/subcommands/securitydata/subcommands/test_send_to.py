...
from code42cli.subcommands.securitydata.subcommands import send_to as sender
...
def extractor(mocker):
    return mocker.patch("code42cli.subcommands.securitydata.subcommands.send_to.extract")
